...
'''Main program'''
dataset, features = load_csv("C:\\Users\\P Sai vinitha\\OneDrive\\Desktop\\foml\\exp.csv")
node1 = build_tree(dataset, features)
print("The decision tree for the dataset using ID3 algorithm is")
print_tree(node1, 0)

testdata, features = load_csv("C:\\Users\\P Sai vinitha\\OneDrive\\Desktop\\foml\exp.py\exp.csv")
